...
Aqui vocês irão encontrar uma breve biografia da nossa equipe. Durante os últimos dias, resolvemos as seguintes situações:

- Ajuste dos erros no código principal
- Documentação do projeto do github no README.md
- Em todas as partes do código comentários explicando o que foi feito
- Usamos o máximo possível o Serial, nele informando os estados da produção
- Colocamos as funcionalidades faltantes
...
Nosso grupo foi contratado para realizar a automação do chão da fábrica de uma farmacêutica responsável por produzir doses de vacina. Nossa equipe irá solucionar esse problema o mais rápido possível para que tenha vacinas para todos. Para saber quem somos, leia a descrição a baixo.
